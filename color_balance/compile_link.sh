# opencv
g++ -std=c++11 color_balance_opencv_main.cpp color_balance_opencv.cpp -L /usr/local/lib/ -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_imgcodecs -o color_balance_opencv
